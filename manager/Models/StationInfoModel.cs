            ...
            using (var context = new NpgsqlDbContext())
            {
                var data = (from station in context.TblStations
                            ...
                            select new StationInfoData
                            {
                                ...
                                Logo = station.FLogo,
                                Rfid = station.FRfid,
                                Lat = $"{station.FLatitude ?? 0}",
                                Long = $"{station.FLongitude ?? 0}",
                                Chargertype = $"{station.FChagerType}",
                                ActionDefault = $"<i class='fa-solid fa-circle-check fa-2x color-online'></i>",
                                ElectricityRate =
                                    station.FChagerType == 1 ? $"<a href='JavaScript:ElectricityrateModal(\"{station.FId}\")' class='btn btn-soft-secondary btn-sm' title='rate'><i class='ri-exchange-dollar-line la-1-50x'></i></a>"
                                    : $"<a href='JavaScript:HourrateModal(\"{station.FId}\")' class='btn btn-soft-secondary btn-sm' title='rate'><i class='ri-exchange-dollar-line la-1-50x'></i></a>",
                                ActionEdit = $"<a href='JavaScript:EditStationModal(\"{station.FId}\")' class='btn btn-soft-secondary btn-sm' title='edit'><i class='ri-edit-box-line la-1-50x'></i></a>",
                                ActionDelete = $"<a href='JavaScript:DeleteStationModalClick(\"{station.FId}\")' class='btn btn-soft-secondary btn-sm' title='delete'><i class='ri-delete-bin-line la-1-50x'></i></a>"
                            })
                            .ToList();
            ...
            using (var context = new NpgsqlDbContext())
            {
                var data = (from station in context.TblStations
                            ...
                            select new StationInfoData
                            {
                                ...
                                Long = $"{station.FLongitude ?? 0}",
                                ActionDefault = $"<i class='fa-solid fa-circle-check fa-2x color-online'></i>",
                                ElectricityRate = $"<a href='JavaScript:ElectricityrateModal(\"{station.FId}\")' class='btn btn-soft-secondary btn-sm' title='rate'><i class='ri-exchange-dollar-line la-1-50x'></i></a>",
                                ActionEdit = $"<a href='JavaScript:EditStationModal(\"{station.FId}\")' class='btn btn-soft-secondary btn-sm' title='edit'><i class='ri-edit-box-line la-1-50x'></i></a>",
                                ActionDelete = $"<a href='JavaScript:DeleteStationModalClick(\"{station.FId}\")' class='btn btn-soft-secondary btn-sm' title='delete'><i class='ri-delete-bin-line la-1-50x'></i></a>"
                            })
                            .ToList();
            ...
            using (var context = new NpgsqlDbContext())
            {
                var data = (from holiday in context.TblHolidays
                            ...
                            select new HolidayData
                            {
                                ...
                                ActionEdit = $"<a href='JavaScript:EditHolidayModal(\"{holiday.FId}\")' class='btn btn-soft-secondary btn-sm' title='edit'><i class='ri-edit-box-line la-1-50x'></i></a>",
                                ActionDelete = $"<a href='JavaScript:DeleteHolidayClick(\"{holiday.FId}\")' class='btn btn-soft-secondary btn-sm' title='delete'><i class='ri-delete-bin-line la-1-50x'></i></a>"
                            })
                            .ToList();
