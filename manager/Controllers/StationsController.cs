...
namespace manager.Controllers
{
    public class StationsController : Controller
    {
        ...
        public IActionResult GetStationsTable()
        {
            ...
            {
                station.ActionHoliday = $"<a href='{Url.Action("Holiday", "Stations", new { id = station.Id })}' class='btn btn-soft-secondary btn-sm' title='View'><i class='ri-calendar-line la-1-50x'></i></a>";
            }
        ...
        public IActionResult CreateHoliday()
        {
            ...
            StationInfoModel.Create(new Entities.TblHoliday()
            {
                ...
                FDay = DateTime.ParseExact(date, "dd/MM/yyyy", new System.Globalization.CultureInfo("en-US")).ToUniversalTime(),
                FName = name
            });
        ...
        public IActionResult UpdateHoliday()
        {
            ...
            holiday.FDay = DateTime.ParseExact(date, "dd/MM/yyyy", new System.Globalization.CultureInfo("en-US")).ToUniversalTime();
            holiday.FName = name;
