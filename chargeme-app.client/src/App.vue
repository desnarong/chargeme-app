    ...
    <div class="flex">
        ...
        <div class="flex-1">
            <header class="flex items-center pl-10 pr-4 pt-4 pb-2">
                <!-- ปรับ pl-4 เป็น pl-10 เพื่อเลื่อนขวา -->
                <!-- Back Icon and Title (ติดซ้าย) -->
    ...
    export default {
        ...
        data() {
            return {
                isLoading: false,
                title: '',
                isEnglish: false // เพิ่มสำหรับ toggle language
            };
        },
        methods: {
            goBack() {
