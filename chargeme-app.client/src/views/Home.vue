<template>
    <div class="flex flex-col items-center">
        ...
        <div class="text-center mb-8 mt-6">
            <img src="../assets/qrcode.jpg" alt="QR Code" class="w-[35%] mx-auto cursor-pointer" @click="goToQRScan" />
        ...
        <div class="w-full mb-6">
            ...
            <input type="text"
                ...
                @keyup.enter="performSearch" v-model="searchQuery" maxlength="8" />
            <button class="w-[100%] bg-blue-500 text-white py-2 rounded-md mt-4" @click="performSearch">
        ...
        <div v-if="Object.keys(user).length > 0" class="w-full text-center mt-6">
            <button class="text-blue-500 mr-4" @click="goToUserProfile">
                User : {{ user.fUsername }}
            </button>
        </div>
    </div>
        ...
        async findCharger(charge) {
            ...
            try {
                ...
                if (response.status === 200){
                    ...
                    Cookies.set('userCookie-' + charge, true, { expires: 1 });
                }
                else {
                    Swal.fire({
...
.swal2-custom-height {
    ...
    /* เพิ่ม padding เพื่อเพิ่มความสูง */
    min-height: 250px;
    /* กำหนดความสูงขั้นต่ำ */
}
