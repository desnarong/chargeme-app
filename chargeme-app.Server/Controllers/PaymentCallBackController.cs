...
namespace chargeme_app.Server.Controllers
{
    ...
    public class PaymentCallBackController : ControllerBase
    {
        ...
        public PaymentCallBackController(IConfiguration configuration, NpgsqlDbContext context, ILogger<PaymentCallBackController> logger, MemoryCacheService cachService)
        {
            _context = context;
        ...
        private async Task<IActionResult> RemoteStartTransaction(Guid chargerId, Guid? connectorId)
        {
